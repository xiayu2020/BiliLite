...
class Adpater_History(private var dataList: MutableList<HistoryData>, val callback: (Int, View) -> Unit) :
    RecyclerView.Adapter<Adpater_History.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.detail.text = dataList[position].author_name
    ...
    fun addData(data: MutableList<HistoryData>): MutableList<HistoryData> {
