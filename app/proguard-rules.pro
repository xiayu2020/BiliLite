...
####################################################################################################
# Keep specific classes from AndroidX
...
# Keep the annotated classes for serialization
-keep,allowobfuscation @interface kotlinx.serialization.Serializable

#-keep class com.jfkj.bililitebyxiayu.** {
#    kotlinx.serialization.annotations.Serializable.** *;
#}
